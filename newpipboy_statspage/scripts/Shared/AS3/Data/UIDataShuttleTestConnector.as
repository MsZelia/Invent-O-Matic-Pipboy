package Shared.AS3.Data
{
   ...
   public class UIDataShuttleTestConnector extends UIDataShuttleConnector
   {
      ...
      override public function Watch(aProviderName:String, DoDispatch:Boolean, existingDataShuttle:UIDataFromClient = null) : UIDataFromClient
      {
      ...
      internal function onLoadComplete(e:Event) : void
      {
         ...
         testLoader.fromClient.SetReady(true);
      }
      
      internal function onLoadFailedPrimaryLocation(e:IOErrorEvent) : *
      {
      ...
      internal function onLoadFailed(e:IOErrorEvent) : *
      {
