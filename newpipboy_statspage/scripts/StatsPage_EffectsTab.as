package
{
   ...
   public class StatsPage_EffectsTab extends IPipBoyTab
   {
      ...
      override public function processProvider(aData:Object) : void
      {
         ...
         stage.dispatchEvent(new CustomEvent("IOMPipboyEFFECTSChange",{"EffectsA":aData.EffectsA}));
      }
      ...
      private function onMouseWheel(aEvent:MouseEvent) : void
      {
         if(aEvent.delta > 0)
         {
            this.ScrollActiveEffects(HEIGHT_OFFSET);
         }
