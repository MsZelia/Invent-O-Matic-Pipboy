package
{
   ...
   public class Pipboy_DataObj
   {
      ...
      private var _ShowXPInfo:Boolean;
      ...
      private var _InvNewItems:Array;
      
      private var _InvKeyItems:Array;
      ...
      private var _QueueSelectQuestID:uint = 4294967295;
      ...
      private var _CollectionsList:Array;
      ...
      {
         this._QueueSelectQuestID = 4294967295;
         ...
         this._DateYear = 0;
         this._TimeHour = 0;
         this._ShowXPInfo = true;
         this._XPLevel = 1;
         this._XPProgressPct = 0;
         this._InvItems = new Array();
         this._InvComponents = new Array();
         this._InvNewItems = new Array();
         this._InvKeyItems = new Array();
         this._InvFilter = 0;
         ...
         this._CollectionsList = new Array();
      ...
      public function get ShowXPInfo() : Boolean
      {
         return this._ShowXPInfo;
      }
      ...
      public function get InvNewItems() : Array
      {
         return this._InvNewItems;
      }
      
      public function get InvKeyItems() : Array
      {
         return this._InvKeyItems;
      }
      ...
      public function get HolotapeServerHandleID() : uint
      {
         return this._HolotapeServerHandleID;
      }
      ...
      public function get queueSelectQuestID() : uint
      {
         return this._QueueSelectQuestID;
      }
      ...
      public function get CollectionsList() : Array
      {
      ...
      public function set ShowXPInfo(param1:Boolean) : *
      {
         this._ShowXPInfo = param1;
      }
      ...
      public function set InvNewItems(param1:Array) : *
      {
         this._InvNewItems = param1;
      }
      
      public function set InvKeyItems(param1:Array) : *
      {
         this._InvKeyItems = param1;
      }
      ...
      public function set HolotapeServerHandleID(param1:uint) : *
      {
         this._HolotapeServerHandleID = param1;
      }
      ...
      public function set queueSelectQuestID(param1:uint) : *
      {
         this._QueueSelectQuestID = param1;
      }
