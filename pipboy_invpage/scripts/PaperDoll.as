package
{
   ...
   public class PaperDoll extends BSUIComponent
   {
      ...
      public function set selectedInfoObj(param1:Array) : void
      {
         this._SelectedInfoObj = param1;
      }
      ...
      public function onDataChange() : *
      {
         ...
         if(this._SelectedInfoObj.length > 0 && this._SlotResists != null)
         {
            ...
            _loc1_ += this.GetSlotResist(this.IDX_GOGGLES);
            _loc1_ += this.GetSlotResist(this.IDX_GAS_MASK);
            ...
            _loc1_ += this.GetSlotResist(this.IDX_UNDERWEAR);
