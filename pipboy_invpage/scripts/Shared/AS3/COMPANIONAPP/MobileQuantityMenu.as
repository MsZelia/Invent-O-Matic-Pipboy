package Shared.AS3.COMPANIONAPP
{
   ...
   public class MobileQuantityMenu extends QuantityMenuNEW
   {
      ...
      internal function __setProp_sliderCLIK_MobileQuantityMenu_CLIKSlider_0() : *
      {
         try
         {
      ...
      internal function __setProp_minusCLIK_MobileQuantityMenu_arrows_0() : *
      {
         try
         {
      ...
      internal function __setProp_plusCLIK_MobileQuantityMenu_arrows_0() : *
      {
         try
         {
